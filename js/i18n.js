...
const translations = {
  en: {
    ...
    toastProfileSaved: "Profile changes saved successfully! ✓",
    ...
    checkoutAddress: "City & Delivery Address",
    checkoutNotes: "Order Notes (Optional)",
    checkoutSubmit: "Confirm & Send via WhatsApp",
    checkoutCancel: "Cancel",
    orderSuccessTitle: "Order Sent Successfully!",
    orderSuccessDesc: "Your order number is:",
    orderWhatsAppNotice: "If WhatsApp didn't open automatically, click the button below:",
    openWhatsAppBtn: "Open WhatsApp Chat",
    trackOrderBtn: "Track Order Status",
    trackTitle: "Track Your Order",
    trackSubtitle: "Enter your Order ID to see live shipping & processing status.",
    trackInputPlaceholder: "e.g. ND-123456 or phone number",
    trackSearchBtn: "Track Order",
    trackNote: "Note: Please enter the Order ID without the '#' symbol (e.g. ND-123456).",
    orderStatusPending: "Pending",
    orderStatusProcessing: "Processing",
    orderStatusShipped: "Shipped",
    orderStatusDelivered: "Delivered",
    orderStatusCanceled: "Canceled",
    // Size Preferences & Product Notices
    profileSizesTitle: "Default Preferred Sizes",
    profileApparelSizeLabel: "Apparel Size (Shirts/Jackets)",
    profilePantsSizeLabel: "Pants Size",
  ...
  ar: {
    ...
    profileSizesTitle: "المقاسات المفضلة المعتمدة",
    profileApparelSizeLabel: "مقاس الملابس (قمصان/جاكيتات/هوديز)",
    profilePantsSizeLabel: "مقاس السروال / البنطال",
    ...
    // Checkout & Order Tracking
    checkoutModalTitle: "إتمام بيانات الطلب",
    checkoutName: "الاسم الكامل",
    checkoutPhone: "رقم الهاتف",
    checkoutAddress: "المدينة وعنوان التوصيل",
    checkoutNotes: "ملاحظات إضافية (اختياري)",
    checkoutSubmit: "تأكيد الطلب والإرسال عبر واتساب",
    checkoutCancel: "إلغاء",
    orderSuccessTitle: "تم إرسال الطلب بنجاح!",
    orderSuccessDesc: "رقم طلبك هو:",
    orderWhatsAppNotice: "إذا لم يفتح الواتساب تلقائياً، اضغط على الزر أدناه:",
    openWhatsAppBtn: "فتح محادثة الواتساب",
    trackOrderBtn: "تتبع حالة الطلب",
    trackTitle: "تتبع حالة طلبك",
    trackSubtitle: "أدخل رقم الطلب لتتبع حالة الشحنة والتجهيز مباشرة.",
    trackInputPlaceholder: "مثال: ND-123456 أو رقم الهاتف",
    trackSearchBtn: "تتبع الطلب",
    trackNote: "ملاحظة: يرجى إدخال رقم الطلب بدون رمز '#' (مثال: ND-123456).",
